...
api.onText(/\/Refer/, function(msg, match) {
	...
	api.sendMessage(fromId,
		"Bonus round! This is optional but worth a shot! Ваша реферальная ссылка: https://t.me/${BOT_USERNAME}?start=${message.from.id}`); Earn up to 50 BPIF tokens by adding up to 10 of your friends into @bitpif / https://t.me/bitpif Telegram group. Each successfully referred member will earn you 5 BPIF tokens.  \n\n" +
